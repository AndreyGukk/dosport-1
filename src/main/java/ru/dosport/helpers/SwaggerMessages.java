...
public final class SwaggerMessages {
    ...
    public static final String PAR_FROM_DATE_ID = "Дата и время начала";
    public static final String PAR_TO_DATE_ID = "Дата и время окончания";
    public static final String PAR_INTERVAL_ID = "Временной интервал";
    ...
    public static final String PAR__DTO = "";
}
